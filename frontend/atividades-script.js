...
function navigateToHome() {
    showNotification('Navegando para a página inicial...', 'info');
...
function navigateToActivities() {
    showNotification('Você já está na página de atividades!', 'info');
}

function navigateToRegistration() {
    showNotification('Navegando para inscrições...', 'info');
}

function navigateToNews() {
    showNotification('Navegando para notícias...', 'info');
}

function navigateToProfile() {
    showNotification('Navegando para o perfil...', 'info');
}
